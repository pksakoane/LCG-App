    ...
    _livesync() {
        ...
        this._bootstrapper().then((moduleRef) => {
            ...
            Application.resetRootView({
                create: () => (getRootPage() instanceof AppHostView ? getRootPage().ngAppRoot : getRootPage()),
            });
        }, (error) => {
            if (NativeScriptDebug.isLogEnabled()) {
