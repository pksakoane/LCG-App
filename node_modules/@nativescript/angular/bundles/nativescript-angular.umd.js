    ...
    ***************************************************************************** */
        ...
        NativeScriptPlatformRef.prototype._livesync = function () {
            ...
            this._bootstrapper().then(function (moduleRef) {
                ...
                core.Application.resetRootView({
                    create: function () { return (getRootPage() instanceof AppHostView ? getRootPage().ngAppRoot : getRootPage()); },
                });
            }, function (error) {
                if (exports.NativeScriptDebug.isLogEnabled()) {
    ...
    var NativeScriptRenderer = /** @class */ (function (_super) {
        ...
        NativeScriptRenderer.prototype.insertBefore = function (parent, newChild, refChild) {
            var _a = refChild instanceof core.View ? { previous: refChild.previousSibling, next: refChild } : { previous: null, next: null }, previous = _a.previous, next = _a.next;
            if (exports.NativeScriptDebug.isLogEnabled()) {
        ...
        NSRouterLink.prototype.ngAfterViewInit = function () {
            ...
            this.el.nativeElement.on('tap', function () {
                _this.ngZone.run(function () {
                    ...
                    _this.navigator.navigate(_this.commands, Object.assign(Object.assign({}, extras), { relativeTo: _this.route, queryParams: _this.queryParams, fragment: _this.fragment, queryParamsHandling: _this.queryParamsHandling, preserveFragment: attrBoolValue(_this.preserveFragment) }));
                });
            });
        };
